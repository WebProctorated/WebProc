...
class Test extends Component {
    ...
    render() {
        ...
        const getTimeMinutes = (time) => (16 - (time % hourSeconds) / minuteSeconds) | 0;
        return (
            <div>
                <div style={{ width: 'fit-content', position: 'absolute', top: '40vh', right: '10vw' }}>
                    <CountdownCircleTimer
                        ...
                        colors={[["#218380"]]}
                        duration={15 * 60}
                        initialRemainingTime={this.state.isPlaying === false ? 15 * 60 : 15 * 60}
                ...
                <button type="button" style={{ margin: 'auto', display: 'block', marginBottom: '2vh', marginTop: '2vh' }} className="btn btn-success" onClick={() => this.handleClick()}>Submit Test</button>
            </div>
        )
    }
}
